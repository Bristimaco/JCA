...
<head>
    ...
    <title>Trainer info: {{ $stage->name }}</title>
</head>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <h1 style="color:#ffffff;margin:0;font-size:22px;">Trainer Informatie — Stage</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:15px;color:#374151;margin:0 0 24px;">
                                De uitnodigingsfase voor de volgende stage is afgesloten. Hieronder vind je de
                                stagegegevens en de deelnemerslijst.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px;">
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="font-size:14px;color:#374151;">
                                            <tr>
                                                <td style="padding:4px 16px 4px 0;font-weight:bold;">Van:</td>
                                                <td style="padding:4px 0;">
                                                    {{ $stage->start_date->format('d/m/Y') }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 16px 4px 0;font-weight:bold;">Tot:</td>
                                                <td style="padding:4px 0;">
                                                    {{ $stage->end_date->format('d/m/Y') }}</td>
                                            </tr>
                                            ...
                                            @if($stage->invitation_deadline)
                                                <tr>
                                                    <td style="padding:4px 16px 4px 0;font-weight:bold;">Uitnodiging
                                                        deadline:</td>
                                                    <td style="padding:4px 0;">
                                                        {{ $stage->invitation_deadline->format('d/m/Y') }}</td>
                                                </tr>
                                            @endif
                                            @if($stage->registration_deadline)
                                                <tr>
                                                    <td style="padding:4px 16px 4px 0;font-weight:bold;">Inschrijving
                                                        deadline:</td>
                                                    <td style="padding:4px 0;">
                                                        {{ $stage->registration_deadline->format('d/m/Y') }}</td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
