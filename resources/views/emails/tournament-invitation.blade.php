                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f9fafb;border-radius:6px;padding:16px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding:16px;">
                                        <h2 style="margin:0 0 12px;color:#111827;font-size:18px;">{{ $tournament->name }}</h2>

                                        <table cellpadding="0" cellspacing="0" style="font-size:14px;color:#374151;">
                                            <tr>
                                                <td style="padding:4px 16px 4px 0;font-weight:bold;vertical-align:top;">Datum:</td>
                                                <td style="padding:4px 0;">{{ $tournament->tournament_date->format('d/m/Y') }}</td>
                                            </tr>
                                            @if($tournament->invitation_deadline)
                                            <tr>
                                                <td style="padding:4px 16px 4px 0;font-weight:bold;vertical-align:top;">Antwoord vóór:</td>
                                            ...
                                            <tr>
                                                <td style="padding:4px 16px 4px 0;font-weight:bold;vertical-align:top;">Adres:</td>
                            ...
                            <div style="margin-bottom:24px;">
                                <a href="https://www.openstreetmap.org/?mlat={{ $tournament->latitude }}&mlon={{ $tournament->longitude }}#map=15/{{ $tournament->latitude }}/{{ $tournament->longitude }}" target="_blank" style="text-decoration:none;">
                                    <img src="https://staticmap.openstreetmap.de/staticmap.php?center={{ $tournament->latitude }},{{ $tournament->longitude }}&zoom=14&size=560x200&markers={{ $tournament->latitude }},{{ $tournament->longitude }},lightblue"
                                         width="560" height="200" alt="Locatie" style="border-radius:6px;display:block;max-width:100%;" />
                                </a>
                            </div>
                            @endif
