...
<head>
    ...
    <title>Herinnering Lidmaatschap</title>
</head>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <h1 style="color:#ffffff;margin:0;font-size:22px;">Herinnering Lidmaatschap</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="font-size:15px;color:#374151;margin:0 0 24px;">
                                Dit is een vriendelijke herinnering dat uw lidmaatschap bij
                                <strong>{{ $club->name }}</strong> binnenkort vernieuwd moet worden.
                            </p>
                            ...
                            <p style="font-size:15px;color:#374151;margin:0 0 24px;">
                                Gelieve uw lidgeld tijdig te betalen zodat uw lidmaatschap zonder onderbreking kan
                                doorlopen. Neem contact op met de club als u vragen heeft.
                            </p>
