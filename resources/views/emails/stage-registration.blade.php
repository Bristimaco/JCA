...
<head>
    ...
    <title>{{ $registered ? 'Inschrijving' : 'Uitschrijving' }} {{ $stage->name }}</title>
</head>
                        ...
                        <td style="padding:32px;">
                            ...
                            @if($registered)
                                <p style="font-size:15px;color:#374151;margin:0 0 24px;">
                                    Je bent ingeschreven voor de stage <strong>{{ $stage->name }}</strong>.
                                </p>
                            @else
                                <p style="font-size:15px;color:#374151;margin:0 0 24px;">
                                    Je inschrijving voor de stage <strong>{{ $stage->name }}</strong> is
                                    geannuleerd.
                                </p>
                            @endif
