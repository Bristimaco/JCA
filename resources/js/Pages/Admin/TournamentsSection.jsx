                ...
                const renderMemberCard = (member) => (
                    <div key={member.id} className="px-4 py-3 border-t border-slate-700 space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {member.age_category && (
                                <span className="inline-flex items-center rounded-full bg-rose-900/30 px-2 py-0.5 text-xs font-medium text-rose-300">{member.age_category}</span>
                            )}
                            {member.weight_category && (
                                <span className="inline-flex items-center rounded-full bg-rose-900/30 px-2 py-0.5 text-xs font-medium text-rose-400">{member.weight_category}</span>
                            )}
                            {member.registration_status === 'registered' && (
                            ...
                            {isPaidTournament && member.payment_status === 'paid' && (
                            ...
                            {isPaidTournament && member.payment_status === 'expired' && (
                            ...
                            {isPaidTournament && member.payment_status === 'pending' && (
