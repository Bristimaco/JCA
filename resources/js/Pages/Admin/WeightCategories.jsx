...
import WeightCategoriesSection from '../Dashboard/WeightCategoriesSection';

export default function WeightCategories({ ageCategories, weightCategories }) {
    return (
        <AppLayout>
            <Head title="Gewichtscategorieën" />

            <div className="mb-6 flex items-center justify-between">
                <h1 className="text-2xl font-bold text-white">Gewichtscategorieën</h1>
