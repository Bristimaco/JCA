...
const moduleIcons = {
    ...
    'Historiek': (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    ),
    'Bestelling Plaatsen': (
    ...
    'Debug': (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11.42 15.17l-5.1-5.1m0 0L11.42 4.97m-5.1 5.1H20.25m-4.83 5.1l5.1-5.1m0 0l-5.1-5.1m5.1 5.1H3.75" /></svg>
    ),
    'Stages': (
...
const moduleColors = {
    ...
    'Historiek': 'from-amber-500 to-yellow-600',
    ...
    'Financieel Rapport': 'from-cyan-600 to-blue-700',
    'Debug': 'from-gray-600 to-slate-700',
    'Stages': 'from-teal-600 to-cyan-700',
    'Stage Archief': 'from-teal-700 to-teal-900',
    'Mijn Producten': 'from-lime-600 to-green-700',
    'Producten': 'from-emerald-600 to-lime-700',
    'Voedingsplan': 'from-green-600 to-emerald-700',
};
...
const moduleGroups = [
    ...
    },
    {
        ...
        modules: [
            ...
            { name: 'Stage Archief', href: '/archief/stages', roles: ['admin', 'coach'], extraModule: 'training' },
        ],
    },
    {
        title: 'Voeding',
        modules: [
            ...
            { name: 'Voedingsplan', href: '/voedingsplan', roles: ['parent', 'member', 'admin', 'coach', 'barmedewerker'] },
        ],
    },
    {
        title: 'Toernooien',
    ...
    },
    {
        ...
        modules: [
            ...
            { name: 'Financieel Rapport', href: '/admin/financieel-rapport', roles: ['admin'], extraModule: 'admin' },
            { name: 'Debug', href: '/admin/debug', roles: ['admin'], extraModule: 'admin' },
        ],
    },
];
