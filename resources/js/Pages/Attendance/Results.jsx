    ...
    if (count === 0) {
        return (
            <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-10">
                ...
                <button onClick={openExitModal} className="mt-8 text-lg text-rose-400 hover:text-rose-300">
                    ← Terug
                </button>
            </div>
        );
        ...
        <div className="h-screen bg-slate-950 flex flex-col overflow-hidden">
            ...
            <div className="flex-shrink-0 px-8 pt-4 pb-2">
                <div className="flex items-center justify-between">
                    <button onClick={openExitModal} className="text-sm text-slate-500 hover:text-slate-400 transition-colors">
                        ← Terug
                    </button>
