...
function AddSponsorForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="px-3 sm:px-6 py-4 border-b border-slate-800 space-y-3">
            <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Nieuwe sponsor</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                    ...
                    <input
                        ...
                        className="w-full rounded-md border border-slate-600 bg-slate-700/50 text-white shadow-sm focus:border-rose-500 focus:ring-rose-500 text-sm"
                    />
                    {form.errors.contract_start_date && <p className="text-sm text-red-400 mt-1">{form.errors.contract_start_date}</p>}
                </div>
                <div>
                    ...
                    <input
                        ...
                        className="w-full rounded-md border border-slate-600 bg-slate-700/50 text-white shadow-sm focus:border-rose-500 focus:ring-rose-500 text-sm"
                    />
                    {form.errors.contract_end_date && <p className="text-sm text-red-400 mt-1">{form.errors.contract_end_date}</p>}
                </div>
            </div>
