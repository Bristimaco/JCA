...
export default function AppLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-slate-900">
            <nav className="sticky top-0 z-50 bg-slate-800/90 backdrop-blur-lg border-b border-slate-700/60 shadow-lg shadow-black/20">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            <Link href="/" className="flex items-center gap-2.5 group">
                                ...
                                <span className="text-lg font-bold text-white tracking-tight group-hover:text-amber-400">
                                    {club?.name || 'JCA'}
                                </span>
                            </Link>
                        </div>
                        <div className="flex items-center gap-2">
                            <a
                                ...
                                title="Handleiding"
                                className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-slate-400 hover:text-amber-400 hover:bg-slate-700/60"
                            >
                            ...
                            <div className="relative" ref={menuRef}>
                                <button
                                    ...
                                    className="flex items-center gap-2 rounded-lg px-3 py-2 hover:bg-slate-700/60"
                                >
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white text-sm font-semibold shadow-sm">
                                ...
                                {userMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-48 rounded-xl bg-slate-800 shadow-lg ring-1 ring-slate-700/50 py-1.5 z-50">
